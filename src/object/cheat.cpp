...
CCheat::CCheat()
{
    ...
    console->AddAlias("winmission", "add_event "+boost::lexical_cast<std::string>(static_cast<int>(EVENT_WIN)));
    console->AddAlias("lostmission", "add_event "+boost::lexical_cast<std::string>(static_cast<int>(EVENT_LOST)));
